    ...
    >
      ...
      {!inSetup && (
        <div>
          ...
          <p className="mt-2 text-xs text-[#5A6B7A] leading-relaxed">
            Asked for so nobody can change it just by picking up your unlocked
            phone.
          </p>
        </div>
      )}
      ...
      {!inSetup && (
        <p className="text-xs text-[#5A6B7A] leading-relaxed">
          Forgotten it? Students ask their teacher; teachers ask the
          administrator. Either can issue a new one.
        </p>
      )}
    </form>
  );
